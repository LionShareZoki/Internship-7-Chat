...
namespace Chat.Data.Migrations
{
    ...
    [Migration("20231224145830_update relations")]
            ...
            modelBuilder.Entity("Chat.Data.Models.Captcha", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7340)
                        },
                        new
                        {
                            CaptchaId = 2,
            ...
            modelBuilder.Entity("Chat.Data.Models.ChannelMember", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            MembershipId = 1,
                            ChannelId = 1,
                            JoinedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7410),
                            UserId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Chat.Data.Models.Message", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RecipientId = 2,
                            SenderId = 1,
                            SentAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7440)
                        },
                        new
                        {
                            MessageId = 2,
            ...
            modelBuilder.Entity("Chat.Data.Models.ProfileSetting", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            SettingId = 1,
                            SettingType = 0,
                            UpdatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7460),
                            UserId = 1
                        },
                        new
                        {
            ...
            modelBuilder.Entity("Chat.Data.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserId = 1,
                            CreatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7510),
                            Email = "user1@example.com",
                            UpdatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7510),
                            isAdmin = false
                        },
                        new
                        {
                            ...
                            UpdatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7520),
                            isAdmin = false
                        },
                        new
                        {
                            UserId = 3,
                            CreatedAt = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7520),
            ...
            modelBuilder.Entity("Chat.Data.Models.UserManagement", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ManagementId = 1,
                            ActionDate = new DateTime(2023, 12, 24, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7530),
                            ActionType = 5,
                            AdminUserId = 1,
                            TargetUserId = 2
                        },
            ...
            modelBuilder.Entity("Chat.Data.Models.UserSession", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserSessionId = 1,
                            ExpiresAt = new DateTime(2023, 12, 31, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7550),
                        ...
                        {
                            UserSessionId = 2,
                            ExpiresAt = new DateTime(2023, 12, 31, 14, 58, 29, 836, DateTimeKind.Utc).AddTicks(7560),
